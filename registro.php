	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="registreo.php" method="POST" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="nombreus">
					...
					<div class="wrap-input100 validate-input" data-validate="Ingrese su contraseña">
						...
						<input class="input100" type="password" name="contraus">
